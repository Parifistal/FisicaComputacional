...
double dr_theta(double L, double E, double r){
    ...
    double raiz;
    if(Discriminante < 0){
        return raiz=sqrt(abs(Discriminante));
    }
    else{
...
Grafica_Gauss_Radio_Theta <<"set title 'Trayectoria de la Tierra'\n";
Grafica_Gauss_Radio_Theta <<"set grid \n";
